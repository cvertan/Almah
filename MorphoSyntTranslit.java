...
public ArrayList<String> getMorphoGloss(){
    return morphoGloss;
}
...
public String getFinalKonsolid() {
	return finalKonsolid;
}
public void setKonsolid(String s) {
	labelKonsolid=s;
}
public void setFinalKonsolid(String s) {
	finalKonsolid=s;
}
	public String getId() {
		return id;
...
public JTree getTreeTranslit() {
	...
	public  ArrayList<TreeNode> listNodes(){
		 ...
		 if(morphoGloss!=null) {
		     for(int i=0;i<morphoGloss.size();i++) {
		         String glossId = morphoGloss.get(i);
		         if (tag != null && tag.mmg != null && tag.mg != null
		                 && tag.mmg.get(glossId) != null) {
		             t.add(tag.mg.get(tag.mmg.get(glossId).intValue()));
		         }
		     }
		 }
		 return t;
