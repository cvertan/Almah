 ...
 * @author Tom Nelson
 */
public class MyDefaultModalGraphMouse<V,E> extends AbstractModalGraphMouse 
     ...
     *
     */
    public MyDefaultModalGraphMouse() {
        this(1.1f, 1/1.1f);
    }
     ...
     */
    public MyDefaultModalGraphMouse(float in, float out) {
        super(in,out);
        loadPlugins();
    ...
    protected void loadPlugins() {
        pickingPlugin = new  MyPickingGraphMousePlugin<V,E>();
        ...
        add(scalingPlugin);add(pickingPlugin);
